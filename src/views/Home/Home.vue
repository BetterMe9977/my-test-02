    ...
    return {
      cardList: [
        ...
        },
        {
          ...
          titleBottom: "開発実績",
          desc:
            "軽井沢オッペンハイムグループのソリューションをご活用いただいているお客様のシステム開発実績や、システム構築例についてご紹介します。",
        ...
        },
        {
          ...
          titleBottom: "自社製品",
          desc:
            "軽井沢オッペンハイムグループがご提供する自社製品をご紹介します。ラーニングサポートサービスは、ナレッジ習得のための最適な提案をAIにより学習者へ提供するWebサービスです。",
        ...
        },
        {
          ...
          titleBottom: "特長",
          desc:
            "フレームワークを利用したシステム開発から大規模システム開発まで、幅広いご要望に対応。豊富な経験といち早い先端技術への取り組みが軽井沢オッペンハイムグループの強みです。",
