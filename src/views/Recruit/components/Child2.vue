  ...
  <div class="child1">
    ...
    <section class="section2">
      ...
      <div class="section-right" style="text-align: center;">
        ...
        <p class="p2">
          ①電話、②Email、にて応募受付を行っております。
          <br />
          応募を希望される方は以下の採用担当にご連絡ください。
          <br />
          詳しい説明をさせて頂きます。
        </p>
        <p class="p3">
          <span class="bold">[ 採用担当 ]</span>
          <br />
          人事部　採用担当者
          <br />
          ① 電話：
          <a href="tel:03-6206-0212">0267-46-9877(本店)</a>
          <a href="tel:045-507-5873">045-507-5873(支店)</a>
          <br />
          ② Email：
...
export default {
  metaInfo: {
    ...
    title: `新卒採用情報 | dreaMTank株式会社`
  },
  name: "MyTest02RecruitChild2",
  components: {
    Client
  },
      ...
      client: {
        items1: {
          sourceData: [
            ...
            {
              th: "就業時間",
              p: ["9：00～18：00（所定勤務時間：8時間）"]
            },
            {
              th: "休日",
              p: ["土日（完全週休2日制）・祝日・年末年始・有給休暇"]
            },
            {
              th: "休暇",
              p: ["慶弔休暇", "特別休暇"]
            },
            {
              th: "福利厚生",
              p: [
                "厚生年金保険／健康保険（関東ITソフトウェア健康保険組合[ITS]）",
                "労災保険／雇用保険",
                "健康診断制度",
                "所得補償保険制度"
              ]
