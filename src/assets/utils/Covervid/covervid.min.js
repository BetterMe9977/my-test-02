var coverVid = function(a, b, c) {
  ...
  document.addEventListener("DOMContentLoaded", e),
    window.addEventListener("resize", d(e, 50)),
  ...
  a.removeAttribute("poster"),
    (a.parentNode.style.backgroundImage = "url(" + f + ")"),
    (a.parentNode.style.backgroundSize = "cover"),
    (a.parentNode.style.backgroundPosition = "center center");
  ...
  (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(
    ...
    (h = !0),
    (!g || h) && a && a.parentNode && a.parentNode.removeChild(a);
};
window.jQuery &&
  jQuery.fn.extend({
    coverVid: function() {
